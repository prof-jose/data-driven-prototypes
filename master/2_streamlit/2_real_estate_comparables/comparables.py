...
# Constants
SHOW_MAP = False  # Set to False while developing to avoid API calls
...
def format_row_info(row):
    ...
    with col2:
        ...
        st.write("📏 " + str(row.surface_reelle_bati.values[0]))

        st.write("### Number of rooms")
        st.write("🛏️ " + str(row.nombre_pieces_principales.values[0]))
